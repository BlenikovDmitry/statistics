...
#вычищает от пустых значений
#вычисляет начальную статистику(разницу)
#объединяет группы в один массив данных
#разбивает на выборочные группы без возврата
#считает по ним выборочную статистику(разницу)
#строит массив выборочных статистик
#строит график распределения выборочных статистик и наносит начальную
#!!! хотя работает с любым количеством групп, работает только с двумя
